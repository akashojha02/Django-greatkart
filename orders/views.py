...
def payments(request):
    ...
    # Move the cartitem to the order product table
    ...
    for item in cart_items:
        ...
        # Reduced the quantity of products
...
def place_order(request, total=0, quantity=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime('%Y%m%d') #20220223
            ...
            return render(request, 'orders/payments.html',context)
             ...
             return HttpResponse('form is nt valid')
    else:
